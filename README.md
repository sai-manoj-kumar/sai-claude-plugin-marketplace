...
|--------|---------|-------------|----------|---------|
| [git-workflow](plugins/git-workflow.md) | 0.8.1 | Slash commands for starting branches, submitting pull requests, and checking CI failures | `start` `submit` `check-gh-workflow` | `cc --plugin-dir ~/git-workflow-plugin` |
