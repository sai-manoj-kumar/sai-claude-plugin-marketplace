...
Step 0 — check the current branch:
  ...
  If the current branch is "main":
    ...
    Follow the same steps as the start command:
      - Ask: "Is this a feature or bugfix? Provide a short description."
      - Run: git checkout -b feature/<short-description>
...
Step 1 — commit staged changes:
  ...
  If there are staged or unstaged changes:
    Ask the user: "Provide a short commit message."
    Run: git add -A
